...
export default {
    ...
    methods: {
        zoom(event) {
            ...
            // Ensure the lens and result are defined
            if (!lens || !result || !resultImage) {
                console.warn('Lens, result, or resultImage is not available.');
                return;
            }
            ...
            // Use a valid check for the result element
            if (result.offsetWidth > 0 && lens.offsetWidth > 0) {
